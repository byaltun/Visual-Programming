...
namespace ProjecyOne
{
    public partial class Ogrenci : Form
    {
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand(kayit, baglanti);
            komut.Parameters.AddWithValue("@p1", textBoxIsimSoyisim.Text);
            komut.Parameters.AddWithValue("@p2", textBoxOgrNo.Text);
            komut.Parameters.AddWithValue("@p3", textBoxDTarihi.Text);
            komut.Parameters.AddWithValue("@p4", textBoxKTarihi.Text);
            komut.Parameters.AddWithValue("@p5", textBoxBolum.Text);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p2", textBoxIsimSoyisim.Text);
            komut.Parameters.AddWithValue("@p3", textBoxOgrNo.Text);
            komut.Parameters.AddWithValue("@p4", textBoxDTarihi.Text);
            komut.Parameters.AddWithValue("@p5", textBoxKTarihi.Text);
            komut.Parameters.AddWithValue("@p6", textBoxBolum.Text);
            komut.ExecuteNonQuery();
            baglanti.Close();
            ogrencilistele();
        }

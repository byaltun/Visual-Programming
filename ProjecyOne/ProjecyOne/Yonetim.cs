...
namespace ProjecyOne
{
    public partial class Yonetim : Form
    {
        ...
        private void btnEkle_Click_1(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p2", textBoxGorev.Text);
            komut.Parameters.AddWithValue("@p3", textBoxYTipi.Text);
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.Parameters.AddWithValue("@p3", textBoxGorev.Text);
            komut.Parameters.AddWithValue("@p4", textBoxYTipi.Text);
            komut.ExecuteNonQuery();
            baglanti.Close();
            yonetimlistele();
